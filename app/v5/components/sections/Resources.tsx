...
import { ArrowUpLeft, BookOpen, MapPin, Stethoscope, TrainFront } from "lucide-react";
...
const cards = [
  {
    ...
    badge: "رایگان",
    icon: Stethoscope,
    title: "مشاوره و تحلیل مو",
    meta: "۲ دقیقه · پاسخ در ۴۸ ساعت",
    text: "شرح حالتان را بنویسید و در صورت تمایل چند عکس اضافه کنید؛ پزشک با یک ارزیابی اولیه و بازه گرافت به شما پاسخ می‌دهد.",
    href: "/v5/diagnostic",
    action: "شروع کنید",
...
export default function Resources() {
  return (
    <section id="centre" className="nc:relative   nc:bg-white   nc:py-24   nc:sm:py-32">
      <div className="nc:mx-auto   nc:max-w-7xl   nc:px-5   nc:sm:px-8">
        <div className="nc:grid   nc:gap-12   nc:lg:grid-cols-12   nc:lg:gap-10">
          ...
          <div className="nc:lg:col-span-7">
            <SectionHeading
              eyebrow="راهنما و ابزار"
              title={"دو ابزار برای\nقدم برداشتن با *خیال راحت*"}
            />
                ...
                <StaggerItem key={c.key}>
                  ...
                  >
                    ...
                    <div className="nc:flex   nc:flex-1   nc:flex-col   nc:p-6">
                      ...
                      <h3 className="nc:mt-2   nc:text-[1.3rem]   nc:font-semibold  ">{c.title}</h3>
                      <p className="nc:mt-2   nc:flex-1   nc:text-[14px]   nc:leading-relaxed   nc:text-graphite">{c.text}</p>
                      <span className="nc:mt-5   nc:inline-flex   nc:items-center   nc:gap-2   nc:text-[13.5px]   nc:font-semibold   nc:text-ink">
                        ...
                        <span className="nc:grid   nc:size-7   nc:place-items-center   nc:rounded-full   nc:bg-ink   nc:text-white   nc:transition-all   nc:duration-500   nc:group-hover:rotate-45   nc:group-hover:bg-sage">
                          <ArrowUpLeft className="nc:size-3.5" />
                        </span>
                      </span>
                    </div>
                  </Link>
            ...
            <div className="nc:relative   nc:flex   nc:h-full   nc:flex-col   nc:overflow-hidden   nc:rounded-[28px]   nc:bg-ink   nc:text-white   nc:shadow-lift">
              <div className="nc:relative   nc:aspect-[4/3]   nc:overflow-hidden">
                <Image
                  ...
                  alt="لابی کلینیک تخصصی کاشت مو، تهران"
                  fill
                ...
                <p className="eyebrow   dot-white   nc:absolute   nc:start-6   nc:top-6   nc:text-sage-soft">کلینیک</p>
              </div>
              <div className="nc:relative   nc:-mt-10   nc:flex   nc:flex-1   nc:flex-col   nc:p-7">
                <h3 className="letterpress-light   nc:text-[clamp(1.5rem,2.4vw,2rem)]   nc:font-semibold   nc:leading-tight  ">
                  یک مکان، یک تیم؛ از اولین مشاوره تا ماه دوازدهم.
                </h3>
                <ul className="nc:mt-6   nc:space-y-3   nc:text-[14px]   nc:text-white/75">
                  ...
                  <li className="nc:flex   nc:items-start   nc:gap-3">
                    ...
                    مترو ونک (خط ۱) · دسترسی آسان از بزرگراه چمران · پارکینگ اختصاصی
                  </li>
                </ul>
                <div className="nc:mt-8   nc:flex   nc:flex-wrap   nc:gap-2">
                  ...
                  <Button href={site.mapsHref} variant="outline" size="sm" icon="external" className="nc:!text-white   nc:!ring-white/30">
                    مسیر کلینیک
                  </Button>
                </div>
              </div>
