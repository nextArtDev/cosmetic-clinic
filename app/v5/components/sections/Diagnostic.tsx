...
const reassurance = [
  { icon: Stethoscope, text: "بازبینی توسط پزشک" },
  { icon: Clock3, text: "پاسخ در ۴۸ ساعت کاری" },
  { icon: ShieldCheck, text: "اطلاعات در ایران نگهداری می‌شود" },
];

export default function Diagnostic() {
  return (
    <section id="diagnostic" className="nc:relative   nc:overflow-hidden   nc:bg-paper   nc:py-24   nc:sm:py-32">
        ...
        <div className="nc:grid   nc:gap-12   nc:lg:grid-cols-12   nc:lg:gap-14">
          <div className="nc:lg:col-span-5">
            <SectionHeading
              ...
              title={"وضعیت موهای خود را\nدرست *بسنجید*"}
              description="سه مرحله، دو دقیقه. شما وضعیتتان را توضیح می‌دهید؛ ما با ارزیابی اولیه و بازه گرافت با شما تماس می‌گیریم."
            />
            ...
            <Reveal delay={3} className="nc:mt-10">
              <div className="nc:relative   nc:aspect-[16/11]   nc:overflow-hidden   nc:rounded-[24px]   nc:shadow-soft">
                <Image
                  ...
                  alt="بررسی پوست سر با تریکوسکوپ دیجیتال"
                  fill
