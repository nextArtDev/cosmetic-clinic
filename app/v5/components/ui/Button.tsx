...
const base =
  "nc:group   nc:relative   nc:inline-flex   nc:items-center   nc:justify-center   nc:gap-2   nc:rounded-full   nc:font-semibold     nc:transition-[background-color,color,box-shadow,transform]   nc:duration-500   nc:ease-[cubic-bezier(.16,1,.3,1)]   nc:overflow-hidden   nc:select-none   nc:disabled:opacity-50   nc:disabled:pointer-events-none";
...
export default function Button({
  ...
  // RTL: the forward action arrow points to inline-start (left in fa-IR)
  const Icon = icon === "external" ? ArrowUpLeft : ArrowLeft;
