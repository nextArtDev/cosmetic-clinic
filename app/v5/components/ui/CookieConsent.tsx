  ...
  return (
    <AnimatePresence>
      {visible && (
        <motion.aside
          role="dialog"
          aria-label="مدیریت کوکی‌ها"
          initial={{ y: 40, opacity: 0, scale: 0.98 }}
          animate={{ y: 0, opacity: 1, scale: 1 }}
          exit={{ y: 30, opacity: 0, scale: 0.98 }}
          transition={{ duration: 0.7, ease: [0.16, 1, 0.3, 1] }}
          className="nc:fixed   nc:bottom-[84px]   nc:start-3   nc:end-3   nc:z-[60]   nc:sm:bottom-5   nc:sm:start-5   nc:sm:end-auto   nc:sm:w-[420px]"
        >
          <div className="frosted   nc:relative   nc:overflow-hidden   nc:rounded-[22px]   nc:p-5   nc:shadow-lift   nc:ring-1   nc:ring-ink/10">
            <div className="nc:flex   nc:items-start   nc:gap-3">
              ...
              <div className="nc:flex-1">
                <h2 className="nc:text-[15px]   nc:font-semibold  ">
                  حریم خصوصی شما، اولویت ماست
                </h2>
                <p className="nc:mt-1.5   nc:text-[13px]   nc:leading-relaxed   nc:text-graphite">
                  برای سنجش بازدید سایت و بهتر شدن تجربه شما از کوکی استفاده می‌کنیم. انتخاب با شماست.
                </p>
              </div>
              <button
                type="button"
              ...
              {prefsOpen && (
                ...
                >
                  <ul className="nc:mt-4   nc:space-y-2   nc:border-t   nc:border-ink/10   nc:pt-4">
                    {[
                      { key: "necessary", label: "ضروری", desc: "امنیت و عملکرد سایت.", locked: true },
                      { key: "analytics", label: "آمار بازدید", desc: "آمار گمنام بازدید سایت." },
                      { key: "marketing", label: "مارکتینگ", desc: "شخصی‌سازی کمپین‌ها." },
                    ].map((row) => {
