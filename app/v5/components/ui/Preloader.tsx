    ...
    <AnimatePresence>
      {show && (
        ...
        >
          ...
          >
            <span className="nc:text-[clamp(2.6rem,9vw,5rem)]   nc:font-extrabold   nc:leading-[1.15]  ">
              کاشت مو
            </span>
            <span className="nc:mt-2   nc:text-[11px]   nc:font-semibold     nc:text-white/60">کلینیک تخصصی</span>
            <span className="nc:relative   nc:mt-6   nc:h-px   nc:w-40   nc:overflow-hidden   nc:bg-white/15">
              <motion.span
                className="nc:absolute   nc:inset-y-0   nc:start-0   nc:bg-sage-soft"
                initial={{ width: "0%" }}
                animate={{ width: "100%" }}
