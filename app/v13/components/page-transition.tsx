 ...
 * only then the navigation happens. Scoped to /v13 links only — the hook
 * is only used by v13 components.
 */
export function useTransitionNavigate() {
  ...
  return useCallback(
    (e: MouseEvent<HTMLAnchorElement>, href: string) => {
      ...
      e.preventDefault()
      document.body.classList.add('v13-no-scroll-transition')
...
export default function PageTransition() {
  ...
  useEffect(() => {
    ...
    if (w && c && document.body.classList.contains('v13-no-scroll-transition')) {
      ...
      gsap.fromTo(
        ...
        { width: '100%' },
        {
          ...
          onComplete: () => {
            ...
            document.body.classList.remove('v13-no-scroll-transition')
          },
        },
      )
    }
