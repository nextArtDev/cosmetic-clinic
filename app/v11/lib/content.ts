 ...
 * fictional Obstetrician & Gynecologist practice (دکتر نگار سلیمی،
 * متخصص زنان، زایمان و نازایی، تهران). The product concept (curated
 * waiting-room screen content) is rebranded as «مدنما». All copy is
 * Persian with Persian digits; CTA links point to the in-page demo
 * form (#cta) instead of the original Calendly URL. When this route
 * becomes the real v11, swap strings/links from the CMS or Prisma.
 */

export const BRAND = {
  name: 'مدنما',
  doctor: 'دکتر نگار سلیمی',
  specialty: 'متخصص زنان، زایمان و نازایی',
} as const
...
export const NUMBERS = {
  title: [
    ...
    { text: 'را در' },
    { text: 'مطب شما', className: 'h2-awesome' },
    { text: 'آزاد کنید' },
  ] as RevealPart[],
  items: [
    {
      ...
      description: [
        { text: '۸۷٪ از مراجعان', className: 'semibold-wrap' },
    ...
    },
    {
      ...
      description: [
        { text: '۹۵٪ از یک پیام', className: 'semibold-wrap' },
        { text: 'در قالب ویدیو در ذهن می‌ماند؛ در برابرِ' },
        { text: 'تنها ۱۰٪ در قالب متن.', className: 'semibold-wrap' },
      ] as RevealPart[],
    },
    {
      ...
      description: [
        { text: '۶۱٪ از مراجعان', className: 'semibold-wrap' },
        { text: 'همان لحظه‌ای که در مطب‌اند، دنبال شناختن خدمات بیشترند؛ اما تیمِ پرکار فرصت توضیح‌دادن ندارد.' },
      ] as RevealPart[],
    },
  ],
}
...
export const PRACTICE = {
  ...
  description:
    'ما بهترین محتوایی که از خدمات شما ساخته‌اید — از سونوگرافی آنومالی و غربالگری تا زایمان بدون درد و مشاورهٔ بارداری — به یک پخش منظم تصویری با به‌روزرسانی لحظه‌ای تبدیل می‌کنیم؛ تا شما ستارهٔ مطب‌تان باشید، همان‌جا که بیمار بیش از هر جای دیگر باید ببیندتان.',
...
export const SOLUTIONS = {
  ...
  description:
    'زحمت جست‌وجو، تدوین، مدیریت، زمان و استرس را از دوش شما برمی‌داریم تا روی مهم‌ترین کار تمرکز کنید: مراقبت از مادران.',
  cards: [
    {
      problem: [
  ...
  items: [
    {
      ...
      role: 'مطب زنان و زایمان، تهران',
      text: 'باورم نمی‌شد یک مانیتور در اتاق انتظار این‌قدر تأثیر بگذارد؛ اما واقعاً شده است. مراجعان به چیزی که پخش می‌شود دقت می‌کنند و خیلی‌ها درباره خدماتی که از وجودشان بی‌خبر بودند سؤال پرسیده‌اند. محتوا دقیقاً حس مطب خودمان را می‌دهد، نه یک تبلیغ کلی. صادقانه، ساده‌ترین ارتقایی بود که تاکنون برای مطبمان انجام داده‌ایم.',
    },
    {
      photo: '/v11/img/review-2.avif',
      name: 'دکتر امیر رستمی',
      role: 'مرکز تصویربرداری زنان، کرج',
      text: 'مدنما روند کار ما را واقعاً متحول کرد! این سامانه فرایندها را منظم می‌کند، آماده‌سازی بیمار برای ویزیت را بهتر می‌شود و مراقبت را ارتقا می‌دهد. رابط کاربری ساده است، قابلیت‌هایش دقیقاً پاسخ‌گوی نیاز ماست و تیم پشتیبانی همیشه پاسخ‌گو و همراه است. به هر همکاری که دنبال ارتقای مطبش است، مدنما را بی‌قید و شرط پیشنهاد می‌کنم.',
    },
    {
      photo: '/v11/img/review-3.avif',
      name: 'مریم احمدی',
      role: 'مراجعِ مطب',
      text: 'اول فکر می‌کردم «خوب است داشته باشیم»، اما مدنما تأثیری غافلگیرکننده داشت. از وقتی نصب شده، داخل اتاق ویزیت درباره خدماتی که روی مانیتور دیده‌ام سؤال می‌کنم؛ انگار یک آموزش‌دهندهٔ آرام در سالن انتظار نشسته — بدون هیچ زحمتی از طرف تیم، اما با نتیجهٔ واقعی. نصبش هم روان بود و تیم، همه‌چیز را ساده کرد.',
    },
  ],
}
...
export const CTA = {
  title: [
    ...
    { text: 'درآمد مطب‌تان را بالا ببرید', className: 'h2-awesome' },
  ] as RevealPart[],
}
