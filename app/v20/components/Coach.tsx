...
const COUNTERS = [
  { count: 18, label: "سال سابقه مربیگری" },
...
export default function Coach() {
  return (
    <section id="coach" data-if-spy="۷" className="if-section">
        ...
        <div className="if-coach-grid">
          <div className="if-coach-photo" data-if-reveal>
            <div className="if-img" data-if-parallax>
              ...
              <img src="/v20/media/coach.jpg" alt="آرش کیانی — سرمربی ایرون‌فیت" loading="lazy" />
            </div>
            <span className="if-exp">
              <b>+۱۸</b>
              <span>سال تجربه مربیگری</span>
            </span>
          </div>
