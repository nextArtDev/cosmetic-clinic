  ...
  const switchPeriod = (toYearly: boolean) => {
    ...
    if (grid) {
      gsap.fromTo(
        ...
        { scale: 1, opacity: 1, duration: 0.55, stagger: 0.06, ease: "back.out(2.2)" }
      );
    }
  };
    ...
    <section id="pricing" data-if-spy="۴" className="if-section">
      ...
      <div className="if-container">
        <div style={{ textAlign: "center" }}>
          ...
          <p className="if-lead" style={{ marginInline: "auto" }} data-if-reveal data-if-delay="0.16">
        ...
        <div className="if-toggle-wrap" data-if-reveal data-if-delay="0.2">
          <div className="if-toggle" ref={toggleRef} role="tablist" aria-label="دوره پرداخت">
            <span
              ref={thumbRef}
