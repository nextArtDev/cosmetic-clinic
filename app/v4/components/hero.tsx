...
const gallery = [
  {
    ...
    alt: 'فضای آرام و روشن کلینیک دکتر شبنم فضلی',
  },
  { image: '/images/doctor-model.webp', alt: 'اتاق مشاورهٔ کلینیک' },
  { image: '/images/doctor.png', alt: 'فضای انتظار کلینیک' },
]
...
export function Hero() {
  ...
  useEffect(() => {
    ...
    const timer = setInterval(
      () => setReview((s) => (s + 1) % reviews.length),
      7800,
    )
    return () => clearInterval(timer)
  ...
  return (
    <section className="hero" ref={ref} aria-label="کلینیک دکتر شبنم فضلی">
      <div className="hero-stage">
        ...
        >
          <div
            ...
            aria-label="تصاویر کلینیک"
          >
            <div className="oval-picture">
                  ...
                  (item, index) =>
                    slide === index && (
                      <motion.img
                        ...
                        exit={{ opacity: 0 }}
                        transition={{
                          opacity: { duration: reduced ? 0 : 1.6 },
              ...
              <span className="image-soft-light" />
            </div>
            <div className="gallery-arrows">
              ...
              <button
                onClick={() => {
                  setSlide((slide + 1) % gallery.length)
                  setPaused(true)
                }}
            ...
            <Magnetic className="scroll-orbit-position">
              <a
                href="#about"
                className="scroll-orbit"
                aria-label="دربارهٔ کلینیک"
              >
            ...
            <div className="gallery-controls">
              {gallery.map((item, index) => (
                <button
                  ...
                  className={`gallery-dot ${slide === index ? 'active' : ''}`}
                  onClick={() => {
                    setSlide(index)
                    setPaused(true)
                  }}
              ...
              <button
                ...
                aria-label={paused ? 'پخش اسلایدشو' : 'توقف اسلایدشو'}
              >
                {paused ? (
        ...
        <div className="hero-copy">
          ...
          >
            کلینیک جراحی پلاستیک و زیبایی دکتر شبنم فضلی در اصفهان؛
            <br className="desktop-break" />
            با دقتِ تخصصی و وسواسِ ظرافت، زیباییِ متناسب با چهرهٔ شما را به
            تصویر می‌کشیم.
          </motion.p>
          <motion.div
          ...
          >
            <img
              src="/v4/images/review-avatar.svg"
              width={34}
              height={34}
              alt=""
            />
            <div className="review-content">
              ...
              <div className="review-dots">
                {reviews.map((_, index) => (
                  <button
                    aria-label={`نظر مراجع ${index + 1}`}
                    aria-pressed={review === index}
                    key={index}
        ...
        >
          <Star className="pegasus-mark" />
          <p className="serif">
            Evoke your true beauty!
            <br />
            زیباییِ واقعی‌ات را بیدار کن.
            <br />
            ما کلینیکِ لبخند تو هستیم.
          </p>
        </motion.div>
      </div>
      <div className="hero-rule inner">
        <img src="/v4/images/shine.svg" alt="" width={49} height={32} />
        <motion.span
          initial={{ scaleX: 0 }}
          animate={{ scaleX: 1 }}
