...
import { Marquee, RotatingText } from './motion'
import { DoctorIntro } from './doctor-intro'
...
/** تیتر هیرو، واژه‌به‌واژه — ماسک هر واژه جدا انیمیت می‌شود (فارسی: هرگز حرف‌به‌حرف). */
const heroWords = 'سلامتی، آغاز هر زندگی'.split(' ')

/** حوزه‌های مراقبت — نوار چرخان زیر هیرو (معادل تیتر چرخان طرح اصلی). */
const careAreas = [
  'مراقبت بارداری',
  'زایمان آرام',
  'سلامت زنان',
...
function Opening() {
  const previewMove = (event: MouseEvent<HTMLButtonElement>) => {
    ...
    gsap.to(event.currentTarget.querySelector('.hero-patch'), {
      x: x * 0.2,
      y: y * 0.2,
      rotation: x * 0.015,
      duration: 0.65,
  ...
  const stories = [
    {
      label: 'پزشکی بر پایهٔ شواهد',
      text: 'هر توصیه در این مطب، پشتوانهٔ پروتکل‌های روز دنیا را دارد؛ نه حدس، نه سنت.',
    },
    {
      label: 'همراهی در هر مرحله',
      text: 'از نخستین ویزیت تا پس از زایمان؛ یک تیم ثابت که مسیر شما را می‌شناسد.',
    },
    {
      label: 'تعهد ما، روشن و شفاف',
      text: 'هیچ‌گاه کاری که لازم نیست انجام نمی‌دهیم. اعتماد شما، سرمایهٔ ماست.',
    },
  ]
  ...
  return (
    <section
      ...
      data-theme="dark"
      aria-label="به دورهٔ سلامت خوش آمدید"
    >
        ...
        <div className="story-scene">
          <picture className="story-image">
            <source
              ...
              srcSet="/v10/assets/background-mobile.5fe12084.jpg"
            />
            <source
              media="(max-width: 1000px)"
              srcSet="/v10/assets/background-tablet.4a08630d.webp"
            />
            <img
              src="/v10/assets/background.ccdc4950.webp"
              alt="فضای آرام مطب؛ مراقبتی دلسوزانه"
              width="3200"
              height="2160"
            />
          </picture>
        ...
        <div className="hero-curtain">
          <div className="hero-inner">
            <picture className="hero-background">
              <source
                media="(max-width: 600px)"
                srcSet="/v10/assets/HeroBGM.97f50e37.webp"
              />
              <img
                src="/v10/assets/HeroBG.cafba854.webp"
                width="3200"
                height="2116"
                alt="فضای آرام و روشن مطب دکتر شریفی"
                fetchPriority="high"
              />
            </picture>
            ...
            <div className="hero-content">
              ...
              <div className="hero-grid">
                <div className="hero-card hero-message">
                  ...
                  <RotatingText words={careAreas} className="hero-rotating" interval={2400} />
                ...
                <button
                  ...
                  onClick={() =>
                    window.dispatchEvent(
                      new CustomEvent('v10:scroll', { detail: '#shop' }),
                    )
                  }
                ...
                >
                  ...
                  <div className="hero-patch">
                    <Image
                      src="/v10/assets/doctor-clinic.jpg"
                      alt="ویزیت و مشاورهٔ حضوری در مطب"
                      fill
                      sizes="25vw"
                    />
                  </div>
                  <span className="preview-hint mono">
                    کمتر معطلی. زودتر به جواب. <ArrowLeft size={14} />
                  </span>
                </button>
                <button
                  className="hero-card hero-preview"
                ...
                >
                  ...
                  <div className="hero-patch">
                    <Image
                      src="/v10/assets/panelTwo.ec8e3c0e.webp"
                      alt="بستهٔ مراقبت پیش از زایمان"
                      fill
                      sizes="25vw"
                    />
                  </div>
                  <span className="preview-hint mono">
                    از نخستین سونو تا لحظهٔ زایمان <ArrowLeft size={14} />
                  </span>
                </button>
                <div className="hero-card hero-discover">
                  ...
                  <Flower />
                  <p>
                    با دکتر مریم شریفی، متخصص زنان و زایمان، از نخستین ویزیت تا
                    لحظهٔ دیدن چهرهٔ کودکتان کنار هستید؛ دقیق، صبور و بدون عجله.
                  </p>
                  <Action href="#how-it-works" className="hero-action">
                    آشنایی با مسیر درمان
                  </Action>
                </div>
              </div>
            </div>
...
/**
 * نوار چرخان زیر هیرو — معادل تیتر چرخان طرح اصلی («Improving Pain
 * Management»). یک واژه در هر لحظه، داخل ماسکی با ارتفاع ثابت، و پایین آن
 * یک نوار مارکی از نام خدمت‌ها که کل عرض صفحه را می‌پیماید.
 */
function Ticker() {
  return (
    <section className="ticker-section" data-theme="light" aria-label="حوزه‌های مراقبت">
      <div className="ticker-inner">
        <span className="ticker-label mono">حوزه‌های مراقبت</span>
        <RotatingText words={careAreas} className="ticker-rotating" interval={2600} />
      </div>
      <Marquee className="ticker-marquee" speed={40}>
    ...
    <div className="patch-stage" aria-hidden="true">
      ...
      <div className="patch-layers">
        ...
        <div className="patch-membrane">
          <svg viewBox="0 0 320 320" fill="none">
            ...
            {Array.from({ length: 9 }, (_, i) => (
              <path
                key={i}
                d={`M${80 - Math.sin(i) * 22} ${70 + i * 23} H230 Q250 ${70 + i * 23} 250 ${80 + i * 23} V${90 + i * 23} H80`}
                stroke="currentColor"
                strokeWidth="1.2"
              />
            ))}
        ...
        <div className="patch-face">
          <Image
            src="/v10/assets/illustration-1.43f3fe6b.png"
            fill
            sizes="38vw"
            alt=""
          />
      ...
      <div className="science-sticky">
        ...
        <div className="science-steps">
          {steps.map((step, index) => {
            ...
            return (
              <article
                className={`science-step science-step-${index + 1}`}
                key={step.title}
              >
                ...
                <p>{step.text}</p>
                <Image
                  className="step-mobile-art"
                  src={step.image}
                  width={450}
                  height={500}
                  sizes="90vw"
                  alt={`تصویر مراحل درمان: ${step.title}`}
                />
        ...
        <PatchDiagram />
        <Action className="science-cta" href="#shop">
          رزرو نوبت و خدمات
        </Action>
        <div className="science-progress" aria-hidden="true">
          <span />
        </div>
      </div>
    </section>
...
function Movement() {
  return (
    <section
      ...
      data-theme="dark"
      aria-label="مراقبتی برای هر سن و شرایط"
    >
      <div className="movement-sticky">
        <div className="movement-marquee" aria-hidden="true">
          <span>
            سلامت زنان <Flower /> سلامت زنان <Flower />
          </span>
        </div>
        <div className="movement-image">
          <Image
            src="/v10/assets/background.042700a4.webp"
            alt="مادر و نوزاد؛ لحظه‌ای آرام پس از زایمان"
            fill
            sizes="100vw"
          />
        ...
        <div className="movement-statement">
          ...
          <p>
            مراقبتی که برای <span className="circled-word">زندگی</span> شما
            طراحی شده؛
            <br />
            برای هر سن، هر شرایط
            <br />و هر <span className="circled-word">انتظاری</span>.
          </p>
          <Flower />
        </div>
...
function UseCases() {
  ...
  return (
    <section
      ...
      data-theme="light"
      aria-label="در هر مرحله‌ای که نیاز دارید"
    >
      <div className="use-sticky">
        ...
        <div className="use-content">
          ...
          <p className="use-description">
            هر سؤالی که دربارهٔ بدن و سلامت خود دارید، این‌جا جای درست پرسیدن آن
            است؛ بدون خجالت، بدون تعارف.
          </p>
          <div className="use-map">
            ...
            >
              <path
                d="M2 3C26 95 98 125 176 88M154 63l35 16-14 37"
                stroke="currentColor"
                strokeWidth="1.5"
                strokeLinecap="round"
              />
            ...
            <div className="use-tags">
              <div className="use-tags-heading">
                <Flower />
                <span>در هر مرحله‌ای که نیاز دارید</span>
              </div>
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  {selected !== null
                    ? useCases[selected].text
                    : 'یک مطب. بی‌شمار راه مراقبت.'}
                </motion.p>
              </AnimatePresence>
            </div>
          </div>
  ...
  return (
    ...
    >
      ...
      <div className="review-track" ref={track}>
        {reviews.map((review) => (
          <article className="review-card reveal" key={review.name} data-cursor="view">
            <Image
              className="stars"
              src="/v10/assets/4.5.3500d8fa.svg"
              alt="۴٫۵ از ۵ ستاره"
              width={96}
              height={16}
            />
...
function ProductCard({
  ...
  return (
    <article className="product-card reveal" data-cursor="view">
      <div className="product-image">
        <Image
          src={product.image}
          alt={`${product.name} — ${product.variant}`}
          fill
          sizes="(max-width: 650px) 90vw, (max-width: 1000px) 45vw, 31vw"
        />
        <span className="product-number mono">۰{index + 1}</span>
        <span className="product-image-caption mono">
          برای روزهای بهتر طراحی شده.
        </span>
      </div>
      ...
      <Action
        ...
        onClick={() => add(product.id, subscription)}
        disabled={!ready}
      >
        افزودن به سبد رزرو
      </Action>
  ...
  return (
    <section className="shop-section" id="shop" data-theme="light">
      <div className="shop-heading reveal">
        ...
        <p>
          پشتوانهٔ ما{' '}
          <button className="text-link" onClick={() => setDialog('guarantee')}>
            تعهد شفاف به شماست
          </button>
          .<br />
          اگر راضی نباشید، ما هم راضی نیستیم.
        </p>
      </div>
      <div className="shop-perks reveal">
        {[
          ...
          <div key={perk.text}>
            <perk.icon size={22} strokeWidth={1} />
            <span>{perk.text}</span>
          </div>
        ))}
      </div>
    ...
    <section className="faq-section" id="faq" data-theme="light">
      <div className="faq-intro">
        ...
        <div className="faq-photo reveal">
          <Image
            src="/v10/assets/faq.0982ca32.webp"
            alt="فضای آرام و خصوصی معاینه در مطب"
            fill
            sizes="(max-width: 800px) 45vw, 31vw"
          />
    ...
    <footer className="site-footer" data-theme="light">
      ...
      <div className="footer-top">
        <p className="footer-mission">
          همراهی دلسوزانه برای
          <br />
          هر مرحله از زندگی شما
        </p>
        ...
        <nav aria-label="ناوبری پابرگ">
          <a href="#shop">
            رزرو نوبت <ArrowLeft size={15} />
          </a>
          <button onClick={() => setDialog('account')}>
            پیگیری درخواست <ArrowLeft size={15} />
          </button>
          <button onClick={() => setDialog('contact')}>
            تماس با ما <ArrowLeft size={15} />
          </button>
        </nav>
        <a href="#top" className="back-top" aria-label="بازگشت به بالای صفحه">
      ...
      <a
        ...
        href="#top"
        aria-label={`${clinic.name} — بازگشت به بالا`}
      >
        {clinic.short}
      </a>
      <div className="footer-fineprint">
        ...
        <p>
          محتوای این صفحه صرفاً نمایشی است و جایگزین ویزیت و توصیهٔ پزشکی نیست.
        </p>
    ...
    () => {
      ...
      mm.add(
        ...
        (context) => {
          ...
          if (reduce) return
          // تیتر هیرو واژه‌به‌واژه از پشت ماسک بالا می‌آید (فارسی: هرگز حرف‌به‌حرف).
          gsap.from('.hero-word', {
            yPercent: 118,
            duration: 1.35,
            ease: 'power4.out',
          ...
          gsap.from('.ticker-inner', {
            y: 34,
            opacity: 0,
            duration: 1,
            ease: 'power3.out',
            scrollTrigger: { trigger: '.ticker-section', start: 'top 88%', once: true },
          })
          ...
          opening
            ...
            .fromTo(
              ...
              { scale: 1, yPercent: -3, duration: 4.15 },
              0,
            )
          ...
          if (desktop) {
            ...
            science
              .to('.patch-layers', { rotationZ: 18, duration: 0.6 }, 0)
              .to(
                '.science-step-1',
                { autoAlpha: 0, y: -25, duration: 0.22 },
                0.85,
              )
              .to(
                '.science-step-2',
              ...
              .to(
                '.patch-layers',
                { rotationX: 52, rotationZ: -28, duration: 0.8 },
                0.8,
              )
              .to(
                '.patch-membrane, .patch-base',
              ...
              .to(
                '.energy-rings',
                { rotation: 75, scale: 1.05, duration: 3.1, ease: 'none' },
                0,
              )
              .to(
                '.science-step-2',
              ...
              .to(
                '.patch-layers',
                { rotationX: 62, rotationZ: 12, duration: 0.8 },
                2,
              )
              ...
              .fromTo(
                ...
                { scaleX: 0 },
                { scaleX: 1, duration: 3.1, ease: 'none' },
                0,
              )
            ...
            use
              .to(
                '.use-photo-track',
                { xPercent: 66.666, duration: 1.6, ease: 'power2.inOut' },
                0.1,
              )
              .fromTo(
                '.use-content',
                { xPercent: -105 },
                { xPercent: 0, duration: 1.6, ease: 'power2.inOut' },
                0.1,
              )
              .to({}, { duration: 0.45 })
          }
          ...
          movement
            .fromTo(
              ...
              {
                clipPath: desktop
                  ? 'inset(16% 35% 16% 35% round 220px)'
                  : 'inset(20% 16% 20% 16% round 180px)',
              },
              {
            ...
            .to(
              '.movement-marquee',
              { xPercent: 25, duration: 2.5, ease: 'none' },
              0,
            )
            .to('.movement-statement', { y: -35, duration: 0.6 }, 1.9)

          // دربارهٔ پزشک — پارالاکس ملایم: پرتره و قاب کوچک مطب با سرعت
          // متفاوت از صفحه حرکت می‌کنند تا عمق ایجاد شود.
          // Reveal پردهٔ پرتره با GSAP انجام می‌شود، نه Framer: Framer
          // رشتهٔ clipPath: inset(...) را این‌جا درون‌یابی نمی‌کند و مهم‌تر
          // آن‌که عنصرِ کاملاً کلیپ‌شده، مستطیل تقاطع خالی دارد و بارگذار
          // تنبل next/image را هم مسدود می‌کند (به همین دلیل آن تصویر eager
          // بارگذاری می‌شود).
          gsap.fromTo(
          ...
          // خدمات — کارت‌ها هنگام ورود دسته‌جمعی بالا می‌آیند.
