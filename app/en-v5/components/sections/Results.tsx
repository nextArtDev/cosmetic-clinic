...
export default function Results() {
  ...
  return (
    <section
      id="resultats"
      className="nc:relative nc:overflow-hidden nc:bg-ink nc:py-24 nc:text-white nc:sm:py-32"
    >
      <div className="grain nc:absolute nc:inset-0" />
      <div className="nc:pointer-events-none nc:absolute nc:-right-32 nc:top-20 nc:size-[560px] nc:rounded-full nc:bg-sage/30 nc:blur-[160px]" />
      ...
      <div className="nc:relative nc:mx-auto nc:max-w-7xl nc:px-5 nc:sm:px-8">
        <div className="nc:grid nc:gap-14 nc:lg:grid-cols-12 nc:lg:gap-10">
          <div className="nc:lg:col-span-6">
            <SectionHeading
              dark
              eyebrow="Avant-après"
              title={'Des résultats naturels,\nvisibles sous *tous les angles*'}
              description="Ce que l'on ne remarque pas est justement ce qui compte : une ligne qui ne se voit pas, une densité qui suit la lumière, une implantation qui tiendra dans le temps."
            />
              ...
              {resultPoints.map((p) => (
                <StaggerItem key={p.index}>
                  <div className="nc:group nc:border-t nc:border-white/12 nc:pt-5">
                    <p className="nc:flex nc:items-center nc:gap-3 nc:text-[12px] nc:font-bold nc:tracking-[0.2em] nc:text-sage-soft">
                      {p.index}
                    ...
                    <h4 className="nc:mt-3 nc:text-[1.15rem] nc:font-semibold nc:tracking-[-0.02em]">
                      {p.title}
                    </h4>
                    <p className="nc:mt-2 nc:text-[14px] nc:leading-relaxed nc:text-white/60">
                      {p.text}
                    </p>
                  </div>
                </StaggerItem>
          ...
          <Reveal delay={2} className="nc:lg:col-span-6">
            <CompareSlider
              ...
              beforeAlt="Vertex clairsemé avant la greffe"
              afterAlt="Vertex densifié douze mois après la greffe"
            ...
            <p className="nc:mt-4 nc:text-[12.5px] nc:text-white/45">
              Photographies illustratives, conditions de prise de vue
              standardisées. Résultats variables selon les patients.
            </p>
          </Reveal>
        </div>
        ...
        <div className="nc:mt-24">
          <div className="nc:mb-8 nc:flex nc:flex-wrap nc:items-end nc:justify-between nc:gap-6">
            <div>
              <p className="eyebrow dot-white nc:text-sage-soft">
                Galerie de cas
              </p>
              <h3 className="letterpress-light nc:mt-3 nc:text-[clamp(1.6rem,3vw,2.3rem)] nc:font-semibold nc:tracking-[-0.03em]">
                Ligne frontale, vertex, tempes : cinq parcours documentés
              </h3>
            </div>
          ...
          <div className="nc:overflow-hidden" ref={emblaRef}>
            <div className="nc:-ml-4 nc:flex nc:touch-pan-y">
              {resultCases.map((c, i) => {
                const active = i === selected
                return (
                  <div
                    key={c.id}
                    className="nc:min-w-0 nc:flex-[0_0_78%] nc:pl-4 nc:sm:flex-[0_0_46%] nc:lg:flex-[0_0_30%]"
                  >
                    <motion.figure
                      animate={{
                        scale: active ? 1 : 0.96,
                    ...
                    >
                      ...
                      <figcaption className="nc:absolute nc:inset-x-0 nc:bottom-0 nc:p-5">
                        <p className="nc:text-[11px] nc:font-bold nc:uppercase nc:tracking-[0.18em] nc:text-sage-soft">
                          {c.grafts} · {c.months}
                        </p>
                        <p className="nc:mt-1.5 nc:text-[15px] nc:font-semibold nc:leading-snug">
                          {c.title}
                        </p>
                      </figcaption>
                    </motion.figure>
          ...
          <div className="nc:mt-8 nc:flex nc:items-center nc:gap-6">
            <div className="nc:relative nc:h-px nc:flex-1 nc:bg-white/15">
              <motion.span
                className="nc:absolute nc:inset-y-[-1px] nc:left-0 nc:w-1/5 nc:rounded-full nc:bg-sage-soft"
