...
export default function CompareSlider({ before, after, beforeAlt, afterAlt, className = "" }: CompareSliderProps) {
  ...
  return (
    ...
    >
      ...
      <span className="nc:absolute nc:right-4 nc:top-4 nc:rounded-full nc:bg-white/85 nc:px-3 nc:py-1 nc:text-[11px] nc:font-bold nc:uppercase nc:tracking-[0.18em] nc:text-ink nc:backdrop-blur">
        Après · 12 mois
      </span>
      ...
      <motion.div style={{ clipPath: clip }} className="nc:absolute nc:inset-0">
        ...
        <span className="nc:absolute nc:left-4 nc:top-4 nc:rounded-full nc:bg-ink/80 nc:px-3 nc:py-1 nc:text-[11px] nc:font-bold nc:uppercase nc:tracking-[0.18em] nc:text-white nc:backdrop-blur">
          Avant
        </span>
      </motion.div>
      ...
      <motion.div style={{ left }} className="nc:absolute nc:inset-y-0 nc:z-10 nc:w-px nc:-translate-x-1/2 nc:bg-white/90 nc:shadow-[0_0_0_1px_rgba(0,0,0,.08)]">
        <motion.span
          ...
          className="nc:absolute nc:left-1/2 nc:top-1/2 nc:grid nc:size-12 nc:-translate-x-1/2 nc:-translate-y-1/2 nc:place-items-center nc:rounded-full nc:bg-white nc:text-ink nc:shadow-lift nc:ring-1 nc:ring-ink/10"
        >
      ...
      {/* Hint */}
      <span className="nc:pointer-events-none nc:absolute nc:bottom-4 nc:left-1/2 nc:-translate-x-1/2 nc:rounded-full nc:bg-ink/70 nc:px-3 nc:py-1 nc:text-[11px] nc:font-medium nc:text-white nc:opacity-80 nc:backdrop-blur nc:transition-opacity nc:duration-500 nc:group-hover:opacity-0">
