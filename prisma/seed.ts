/**
 * Seed — single plastic-surgery doctor ("دکتر شبنم فضلی").
 *
...
async function main() {
  ...
  await prisma.doctorProfile.upsert({
    ...
    create: {
      ...
      bio: 'دکتر شبنم فضلی، فوق تخصص جراحی پلاستیک، زیبایی و ترمیمی، با بیش از ده‌سال تجربه در جراحی‌های رینوپلاستی، فیس‌لیفت، لیپوساکشن، پروتز سینه و چانه و گونه و خدمات سرپایی (تزریق ژل، بوتاکس و مزوتراپی) است. رویکرد ایشان بر نتیجه طبیعی، ایمنی بیمار و مشاوره دقیق پیش از عمل و اجرای پروتکل استاندارد است.',
