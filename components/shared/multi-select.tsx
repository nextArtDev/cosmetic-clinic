  ...
  return (
    ...
    >
      {value?.map((itemValue, index) => {
        const selectedOption = options?.find((opt) => opt.value === itemValue)
        const displayLabel = selectedOption ? selectedOption.label : itemValue
        return (
          <Badge
            key={itemValue}
            className={cn(
          ...
          >
            ...
            <button
              aria-label={`Remove ${displayLabel} option`}
              type="button"
...
>(({ className, ...props }, ref) => {
  ...
  return (
    <CommandPrimitive.Input
      ...
      className={cn(
        'mr-2 text-xs bg-transparent outline-none placeholder:text-muted-foreground flex-1',
        className,
