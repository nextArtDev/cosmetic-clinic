...
// https://seraui.com/docs/orbit-carousel
...
export default function PersonnelCarousel() {
  ...
  return (
    <div
      className="flex flex-col items-center p-4 relative min-h-[400px] bg-white transition-colors duration-300"
    ...
    >
      ...
      >
        ...
        <AnimatePresence mode="wait">
          <motion.div
            ...
            className="z-10 bg-white dark:bg-gray-950/20 backdrop-blur-sm shadow-xl dark:shadow-2xl dark:shadow-gray-900/50 rounded-xl p-3 md:p-4 w-48 md:w-52 text-center border border-gray-100 dark:border-gray-800"
          >
            <motion.img
      ...
      {/* Progress Indicator */}
      <div className="flex justify-center mt-6 gap-x-1.5">
        {people.map((_, index) => (
          <motion.button
            key={index}
